<?php
session_start();
$title = 'Tambah Pengalaman Pengabdian';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    Pengabdian::create($dosen_id, $_POST['judul_pengabdian'], $_POST['sumber_dana'], 
    $_POST['tahun'], $_POST['jumlah_dana']);
    $message = "<script>
    Swal.fire({
        title: 'Berhasil',
        text: 'Pengalaman Pengabdian berhasil ditambah!',
        icon: 'success',
                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Tambah Pengalaman Pengabdian</h3>
                                <p class="text-subtitle text-muted">
                                    Halaman Tambah Pengalaman Pengabdian
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <form method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="judul_pengabdian" class="form-control" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <a href="/PBL-Lab-BA/admin/pengabdian/view.php?halaman=pengabdian" class="btn btn-secondary">Kembali</a>
                                </form>
                            </div>
                        </div>
                    </section>
