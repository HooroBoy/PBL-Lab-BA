...
$id = $_GET['id'];
$data = BidangKeahlian::find($id);

if ($_SERVER["REQUEST_METHOD"] == "POST") {
    BidangKeahlian::update($id, $_POST['nama']);
    $message = "<script>
    Swal.fire({
        title: 'Berhasil',
        text: 'Bidang Keahlian berhasil diubah!',
        icon: 'success',
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="post">
                                    ...
                                    <a href="view.php?halaman=bidang_keahlian" class="btn btn-secondary">Kembali</a>
                                </form>
                            </div>
                        </div>
                    </section>
