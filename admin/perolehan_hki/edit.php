<?php
session_start();
$title = 'Edit Pengalaman Perolehan HKI';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    PerolehanHki::update($id, $dosen_id, $_POST['judul_tema_hki'], $_POST['jenis'],
    $_POST['tahun'], $_POST['nomor_id']);
    $message = "<script>
    Swal.fire({
        title: 'Berhasil',
        text: 'Perolehan HKI berhasil diubah!',
        icon: 'success',
                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Ubah Perolehan HKI</h3>
                                <p class="text-subtitle text-muted">
                                    Halaman Ubah Perolehan HKI
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <form method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="judul_tema_hki" class="form-control" value="<?= isset($data['judul_tema_hki']) ? $data['judul_tema_hki'] : '' ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label>Nomor ID</label>
                                        <input type="text" name="nomor_id" class="form-control" value="<?= isset($data['nomor_id']) ? $data['nomor_id'] : '' ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label>Jenis</label>
                                        <input type="text" name="jenis" class="form-control" value="<?= isset($data['jenis']) ? $data['jenis'] : '' ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label>Tahun</label>
                                    ...
                                    <a href="view.php?halaman=perolehan_hki" class="btn btn-secondary">Kembali</a>
                                </form>
                            </div>
                        </div>
                    </section>
