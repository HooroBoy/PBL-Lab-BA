...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    KaryaBuku::create($dosen_id, $_POST['judul_buku'], $_POST['jumlah_halaman'], 
    $_POST['tahun'], $_POST['penerbit']);
    $message = "<script>
    Swal.fire({
        title: 'Berhasil',
        text: 'Karya Buku berhasil ditambah!',
        icon: 'success',
                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Tambah Karya Buku</h3>
                                <p class="text-subtitle text-muted">
                                    Halaman Tambah Karya Buku
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="post">
                                    ...
                                    <a href="/PBL-Lab-BA/admin/karya_buku/view.php?halaman=buku" class="btn btn-secondary">Kembali</a>
                                </form>
                            </div>
                        </div>
                    </section>
