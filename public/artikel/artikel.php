    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <?php foreach ($articles as $article): ?>
                ...
                <a href="/artikel-detail/<?php echo htmlspecialchars($article['slug']); ?>" class="group bg-white rounded-xl shadow-lg overflow-hidden transition duration-300 transform hover:scale-[1.02] border border-gray-200">
                    <!-- Foto Artikel -->
                    <div class="relative overflow-hidden">
                        <img class="w-full h-56 object-cover transition duration-500 group-hover:opacity-90" 
                             src="/assets/images/articles/<?php echo htmlspecialchars($article['thumbnail']); ?>" 
