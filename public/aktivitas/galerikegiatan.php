                ...
                <div class="group bg-white rounded-xl shadow-lg overflow-hidden transition duration-300 transform hover:scale-[1.02] border border-gray-200">
                    ...
                    <div class="relative overflow-hidden">
                        <img class="w-full h-56 object-cover transition duration-500 group-hover:opacity-90" 
                             src="/assets/images/galeri/<?php echo htmlspecialchars($activity['gambar']); ?>" 
                             alt="<?php echo htmlspecialchars($activity['judul']); ?>"
                             onerror="this.onerror=null; this.src='https://placehold.co/500x350/ECF2FB/124874?text=<?php echo urlencode($activity['judul']); ?>';"
                        />
