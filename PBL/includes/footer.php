            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white space-y-16">
                ...
                <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 md:space-x-4 pt-8 border-t border-white-800">
                    ...
                    <div class="flex space-x-3">
                        <!-- Instagram Icon (Diubah menjadi Gambar) -->
                        <a href="https://www.instagram.com/jtipolinema/" class="w-10 h-10 flex items-center justify-center bg-white rounded-full text-white hover:bg-white/10 transition duration-200">
                             <img src="<?php echo BASE_URL; ?>../assets/Logo/Instagram.png" alt="Instagram Icon" class="w-auto h-5"
                                  onerror="this.onerror=null; this.src='https://placehold.co/20x20/FFFFFF/124874?text=IG';" />
                        </a>
                        <!-- Youtube Icon (Diubah menjadi Gambar) -->
                        <a href="https://www.youtube.com/@jtipolinema367" class="w-10 h-10 flex items-center justify-center bg-white rounded-full text-white hover:bg-white/10 transition duration-200">
                             <img src="<?php echo BASE_URL; ?>../assets/Logo/Youtube.png" alt="Youtube Icon" class="w-auto h-5"
